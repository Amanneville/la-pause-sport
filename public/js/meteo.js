...
var callBackSucess = function callBackSucess(data) {
...
function buttonClickGET() {
  ...
  $.get(url, callBackSucess).done(function () {//alert ("second sucess" );
  }).fail(function () {
    alert("error");
