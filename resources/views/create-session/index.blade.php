        ...
        <form action="" method="post">
            ...
            <div class="col-md-6"> {{-- ATTENTION C EST UN EXEMPLE LES SPORTS SONT RENSEIGNES ALEATOIREMENT--}}
                ...
                <div class="form-group col-md-6 pt-5">
                    ...
                    <input type="time" class="form-control" id="heure" name="heure_debut" class="{{$errors->has('heure_debut') ? 'has-error' : '' }}">
                ...
                <div class="form-group col-md-6 pt-5">
                    ...
                    <input type="time" class="form-control" id="heure" name="heure_fin" class="{{$errors->has('heure_fin') ? 'has-error' : '' }}">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="adresse" name="adresse" class="{{$errors->has('adresse') ? 'has-error' : '' }}">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" id="nb_max_participants" name="nb_max_participants" class="{{$errors->has('nb_max_participants') ? 'has-error' : '' }}">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="ville" name="ville" class="{{$errors->has('ville') ? 'has-error' : '' }}">
                    @if($errors->has('ville'))
                        <span class="help-block">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="prix" class="form-control" id="prix" name="prix" class="{{$errors->has('prix') ? 'has-error' : '' }}">
                    @if($errors->has('prix'))
                        <span class="help-block">
