                                        ...
                                        <div class="card col-md-4 mb-2" style="width: 18rem;">
                                            <div class="center">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">+</p>
                                                    <button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="vous devez être connecter pour voir les informations de la session"> Accès seulement aux membres</button>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card col-md-4 mb-2" style="width: 18rem;">
                                                <div class="center">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <button  class="btn btn-success " data-toggle="tooltip" data-placement="top" title="vous devez être connecter pour voir les informations de la session">informations session</button>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
