...
<div class="container-fluid" style="width:auto; height:800px">
    <div class="row justify-content-center back1">
        <div class="col-md-8">
            <div class="card animate__animated animate__backInDown" style="width:100%px; position: relative; top: 100px">
                <div class="card-header">{{ __('Connexion membre') }}</div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btnViolet">
                                    {{ __('Connexion') }}
                                </button>
