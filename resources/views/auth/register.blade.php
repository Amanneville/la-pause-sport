...
@section('content')
    <script type="text/javascript">
        ...
        function AfficherEleve(role3)
        {
            var test = document.getElementById("role3").style.display;
            if (test == "block")
            {
            ...
            else
            {
                ...
                document.getElementById("r_coach").value = "3";
            }
        }

        function AfficherCoach(role2)
        {
            var test = document.getElementById("role2").style.display;
            if (test == "block")
            {
            ...
            else
            {
                ...
                document.getElementById("r_coach").value = "2";
            }
        }
...
{{--FIN PARTIE AUTHENTIFICATION--}}
     ...
     <div class="form-group row mt-5">
         <div class="col-md-10">
             <b><label for="role" class="col-md-4 col-form-label text-md-right" >{{ __('Membre ou Coach ?') }}</label></b>
         </div>
     </div>

     <div class="form-group row mt-2">
         <div class="col-md-12">
             <select id="role" class="form-control @error('role') is-invalid @enderror" name="role" style="display: none">
                 <option id="r_eleve" value="3"><input type="button" style="width: 400px" onclick='AfficherEleve("role3"); return false' value="Je veux juste pratiquer du sport"></option>
             </select>
         </div>
     </div>
         ...
         <div class="col-md-12">
             <select id="role" class="form-control @error('role') is-invalid @enderror" name="role" style="display: none">
                 <option id="r_coach" value="2"><input type="button" style="width: 400px" onclick='AfficherCoach("role2"); return false' value="Je souhaite coacher des élèves"></option>
             </select>
         </div>
     </div>
...
<br>
        <p>ELEVES</p>
     <p>Merci d'indiquer votre niveau dans chacun des sports : </p>
                {{-- MUSCULATION--}}
                <div class="form-group row">
