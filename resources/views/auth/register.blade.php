                    ...
                    <div class="card animate__animated animate__backInDown"
                        ...
                        <div class="card-header">{{ __('Register') }}
                            ...
                            <div class="card-body">
                                ...
                                <button id="registerCoach" class="btn btn-primary" type="button">Coach</button>
                                <button id="registerMember" class="btn btn-primary" type="button">Membre</button>

                                <form enctype="multipart/form-data" method="POST" action="{{ route('register') }}" class="d-none">
                                    @csrf
                                    ...
                                    <div id="sports" class="d-none">
                                        ...
                                        <div class="form-group row">
                                            <label for="sportMusculation"
                                                   class="col-md-4 col-form-label text-md-right">{{ __('Sport') }}</label>
                                            <div class="col-md-6">
                                            ...
                                            <label for="niveauSportMusculation"
                                                   class="col-md-4 col-form-label text-md-right">{{ __('Niveau') }}</label>
                                            <div class="col-md-6">
